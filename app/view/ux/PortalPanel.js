 ...
 */
Ext.define('App.view.ux.PortalPanel', {
    ...
    requires: [
        ...
        'App.view.ux.PortalDropZone',
        'App.view.ux.PortalColumn'
    ],
    ...
    // Set columnWidth, and set first and last column ux to allow exact CSS targeting.
    ...
    initEvents : function(){
        this.callParent();
        this.dd = Ext.create('App.view.ux.PortalDropZone', this, this.dropConfig);
    },
