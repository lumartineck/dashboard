 ...
 */
Ext.define('App.view.ux.PortalDropZone', {
    extend: 'Ext.dd.DropTarget',

    constructor: function(portal, cfg) {
        this.portal = portal;
        Ext.dd.ScrollManager.register(portal.body);
        App.view.ux.PortalDropZone.superclass.constructor.call(this, portal.body, cfg);
    ...
    unreg: function() {
        ...
        App.view.ux.PortalDropZone.superclass.unreg.call(this);
    }
});
